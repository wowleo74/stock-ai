...
st.markdown("""
    <head>
        ...
        <link rel="icon" type="image/png" href="https://raw.githubusercontent.com/wowleo74/stock-ai/main/icon.png">
        <link rel="shortcut icon" href="https://raw.githubusercontent.com/wowleo74/stock-ai/main/icon.png">
    </head>
